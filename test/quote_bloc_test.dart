...
//     expectLater(quoteBloc, emitsInOrder([QuoteEmpty(), emitsDone]));
//     quoteBloc.close();
//   });
...
//     blocTest(
//         'emits [QuoteEmpty, QuoteLoading, QuoteLoaded] when FetchQuote is added and fetchQuote succeds',
//         build: () {
...
//     blocTest(
//       'emits [QuoteEmpty, QuoteLoading, QuoteLoaded] when FetchQuote is add and fetchQuote fails',
//       build: () {
//         when(quoteRepository.fetchQuote())
